...
parser.add_argument('--val_rgb_root', type=str, default='../Dataset/RGB-D/test_in_train/RGB/', help='the test rgb images root')
parser.add_argument('--val_depth_root', type=str, default='../Dataset/RGB-D/test_in_train/depth/', help='the test depth images root')
parser.add_argument('--val_gt_root', type=str, default='../Dataset/RGB-D/test_in_train/GT/', help='the test gt images root')
parser.add_argument('--test_path',type=str,default='../Dataset/RGB-T/Test/',help='test dataset path')


parser.add_argument('--rgbt', default=0)
