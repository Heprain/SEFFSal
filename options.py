...
parser.add_argument('--rgb_root', type=str, default='../Dataset/RGB-D/Train/RGB/', help='the training rgb images root')
parser.add_argument('--depth_root', type=str, default='../Dataset/RGB-D/Train/depth/', help='the training depth images root')
parser.add_argument('--gt_root', type=str, default='../Dataset/RGB-D/Train/GT/', help='the training gt images root')
parser.add_argument('--test_rgb_root', type=str, default='../Dataset/RGB-D/test_in_train/RGB/', help='the test rgb images root')
parser.add_argument('--test_depth_root', type=str, default='../Dataset/RGB-D/test_in_train/depth/', help='the test depth images root')
parser.add_argument('--test_gt_root', type=str, default='../Dataset/RGB-D/test_in_train/GT/', help='the test gt images root')
