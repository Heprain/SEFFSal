...
from SEFF.models import SEFFSal as net
...
def validateModel(args, model, image_list, label_list, depth_list, savedir):
    ...
    for idx in tqdm(range(len(image_list))):
        ...
        # img_out1, _ = model(img_variable, depth=depth_variable)
        # img_out1 = model(img_variable, depth=depth_variable)
...
def main(args, data_list):
    ...
    dep_root = args.test_path + data_list + '/T/' 
...
if __name__ == '__main__':
    ...
    # data_lists = ['VT821','VT1000','VT5000']
